...
| **S5** | WhatsApp + e-mail | E6 | ~35 | WAHA GOWS atrás de `MessagingProvider`; checkbox de ciência + QR; confirmação e lembretes 24h/2h; e-mail Resend fallback; kill switch. Checklist: [desenvolvimento/sprints/S5-whatsapp-notificacoes.md](./desenvolvimento/sprints/S5-whatsapp-notificacoes.md) |
